...
Require london.blocks.
Require london.bloom.
Require london.fork_types.
Require london.state.
Require london.transactions.
Require london.trie.
Require london.utils.message.
Require london.vm.interpreter.
...
Definition validate_header : M unit :=
  (*
      ...
      *)
  (* TODO statement *)
  let* expected_base_fee_per_gas := INITIAL_BASE_FEE in
  (* TODO statement *)
  (* TODO statement *)
