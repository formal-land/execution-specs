...
Definition generic_create (evm : Evm) (endowment : U256) (contract_address : Address) (memory_start_position : U256) (memory_size : U256) (init_code_gas : Uint) : M unit :=
  (*
...
Definition selfdestruct (evm : Evm) : M unit :=
  ...
  do* [[ state.move_ether ~(|
    ...
    M.get_local ~(| "originator_balance" |)
  |) ]] in
  (* TODO statement *)
  (* TODO statement *)
  (* TODO assignment *)
